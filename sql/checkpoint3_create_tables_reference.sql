-- Checkpoint 3 reference schema.
-- Based on the teammate cleaned-data schema, with the application-side tables
-- aligned to the revised ER design. Referential-integrity constraints are kept.
